...
CNV_hunter.pl 
 -chr <16>
 -range <32438272-32505195>
 -state <state2,cn=1>
 -control <Control rawcnv file> 
 -pc <% identity for call (default to 70?)> 
 -out <outfile> 
...
my %params;
my ($Casefile,$Controlfile,$percent,$Outfile);

#check if output files exist in the current directory						


%params=@ARGV;
$params{"-case"} || die "Parameter \"-chr\" is missing.Please specify a case.\n";
...
#print TESTOUT "Pos_Case\tNeg_Case\tPos_Control\tNeg_Control\tNI_Bigger_Cases\tNI_Smaller_Cases\tNI_Big&SmallCases\tNI_Bigger_Controls\tNI_Smaller_Control\tNI_Big&SmallControl\n";
print "Pos_Case\tNeg_Case\tPos_Control\tNeg_Control\tNI_Bigger_Cases\tNI_Smaller_Cases\tNI_Big&SmallCases\tNI_Bigger_Controls\tNI_Smaller_Control\tNI_Big&SmallControl\n";
...
# 		##my ($PresCont,$AbsCont,$NI_BIGControl,$NI_SMALLControl,$NI_BSControl) = &Hunter(\%CONTROLS,$Caseline,"Case-Control",$percent);
# 		
...
my $Caseline = $Cases[0];
chomp $Caseline;
my ($PresCase,$AbsCase,$NI_BIGCases,$NI_SMALLCases,$NI_BSCases) = &Hunter(\%CASES,$Caseline,"Case-Case",$percent);
my ($PresCont,$AbsCont,$NI_BIGControl,$NI_SMALLControl,$NI_BSControl) = &Hunter(\%CONTROLS,$Caseline,"Case-Control",$percent);
#print TESTOUT "$PresCase\t$AbsCase\t$PresCont\t$AbsCont\t$NI_BIGCases\t$NI_SMALLCases\t$NI_BSCases\t$NI_BIGControl\t$NI_SMALLControl\t$NI_BSControl\n";
print "$PresCase\t$AbsCase\t$PresCont\t$AbsCont\t$NI_BIGCases\t$NI_SMALLCases\t$NI_BSCases\t$NI_BIGControl\t$NI_SMALLControl\t$NI_BSControl\n";
